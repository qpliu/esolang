...
`)
	...
	expected = `define {{i8, [0 x i1]}*, i8} @popStack({i8, [0 x i1]}* %stackval, i8 %stackoffset, [1 x i8*] %stackimport, {i8, [0 x i1]}* %retvalue) { %1 = insertvalue {{i8, [0 x i1]}*, i8} {{i8, [0 x i1]}* null, i8 0}, {i8, [0 x i1]}* %retvalue, 0 %2 = extractvalue [1 x i8*] %stackimport, 0 %3 = bitcast i8* %2 to {i32, i32, i32, [0 x i8]*}* %4 = getelementptr {i32, i32, i32, [0 x i8]*}, {i32, i32, i32, [0 x i8]*}* %3, i32 0, i32 1 %5 = load i32, i32* %4 %6 = icmp ugt i32 %5, 0 br i1 %6, label %l1, label %l2 l1: %7 = sub i32 %5, 1 store i32 %7, i32* %4 %8 = udiv i32 %7, 8 %9 = urem i32 %7, 8 %10 = getelementptr {i32,i32,i32,[0 x i8]*}, {i32,i32,i32,[0 x i8]*}* %3, i32 0, i32 3 %11 = load [0 x i8]*, [0 x i8]** %10 %12 = getelementptr [0 x i8], [0 x i8]* %11, i32 0, i32 %8 %13 = load i8, i8* %12 %14 = zext i8 %13 to i32 %15 = lshr i32 %14, %9 %16 = trunc i32 %15 to i1 %17 = getelementptr {i8, [0 x i1]}, {i8, [0 x i1]}* %retvalue, i32 0, i32 1, i8 0 store i1 %16, i1* %17 br label %l2 l2: ret {{i8, [0 x i1]}*, i8} %1 }`
	if buf.String() != expected {
