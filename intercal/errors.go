...
var (
	...
	Err017 = &Error{"017", "An expression contains a syntax error.", "DO YOU EXPECT ME TO FIGURE THIS OUT?", nil, 0}
	Err079 = &Error{"079", "Improper use has been made of statement identifiers.", "PROGRAMMER IS INSUFFICIENTLY POLITE", nil, 0}
	Err099 = &Error{"099", "Improper use has been made of statement identifiers.", "PROGRAMMER IS OVERLY POLITE", nil, 0}
