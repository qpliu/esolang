...
define void @stash_var(%vrbl* %var) {
    ...
    call void @llvm.memset.p0i8.i32(i8* %mallocresult,i8 0,i32 ptrtoint(%vrbl_val* getelementptr(%vrbl_val,%vrbl_val* null,i32 1) to i32),i1 0)
...
define void @stash_arr(%arr_vrbl* %arr) {
  ...
  stash_uninitialized:
    ...
    call void @llvm.memset.p0i8.i32(i8* %zerodim_mallocresult,i8 0,i32 ptrtoint(i32* getelementptr(%arr_val,%arr_val* null,i32 0,i32 3,i32 0) to i32),i1 0)
  ...
  malloc_newval:
    ...
    call void @llvm.memcpy.p0i8.p0i8.i32(i8* %mallocresult,i8* %oldval_i8star,i32 %mallocsize,i1 0)
