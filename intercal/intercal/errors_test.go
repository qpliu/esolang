...
func TestErrors(t *testing.T) {
	...
	testErrorAt(t, "DON'T GIVE UP DON'T GIVE UP DO GIVE UP", "ICL079I PROGRAMMER IS INSUFFICIENTLY POLITE\n\tON THE WAY TO STATEMENT nnnn\n\tCORRECT SOURCE AND RESUBMIT")
	testErrorAt(t, "DON'T GIVE UP PLEASE DON'T GIVE UP PLEASE GIVE UP", "ICL099I PROGRAMMER IS OVERLY POLITE\n\tON THE WAY TO STATEMENT nnnn\n\tCORRECT SOURCE AND RESUBMIT")
}
