...
(2)	DO FORGET #1
	...
	PLEASE MARK HINT #3 AS HINTED AND BUMP LAMP LIFETIME UP TO #1000
(3)	DO (4) NEXT
	DO FORGET #1
	DO .1 <- #1
	DO (55601) NEXT DO NOTE RSPEAK
...
(21)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO (30152) NEXT DO NOTE .1 <- LOC.FORBIDDEN TO PIRATE
	DO .2 <- #1
	DO (100) NEXT DO NOTE IF LOC.FORBIDDEN TO PIRATE
...
(61)	DO FORGET #1
	...
	DO (40021) NEXT DO NOTE IF KNFLOC NE #65535, .1 <- LOC, ELSE, .1 <- #65535
	DO ,61000SUB#7 <- .1 DO NOTE IF KNFLOC NE #65535, KNFLOC <- LOC
	DO .1 <- ,61000SUB#10 DO NOTE .1 <- DFLAG
	...
	DO .2 <- #95
	DO (1030) NEXT
	DO .4 <- .3 DO NOTE .4 <- (DFLAG - #2)*#95
	DO (1900) NEXT
	DO .2 <- #1000
	DO (40001) NEXT DO NOTE .3 <- RAND(#1000).
	DO .1 <- .3
	DO .2 <- .4
	DO (40004) NEXT DO NOTE .3 <- RAND(#1000) LT (DFLAG - #2)*#95
	DO .1 <- .3
	DO .2 <- #0
	DO (51) NEXT DO NOTE IF .3 <- RAND(#1000) GE (DFLAG - #2)*#95
	DO .1 <- .7
	DO (1020) NEXT
...
(82)	DO .1 <- .8
	...
	DO .1 <- .8
	DO (30111) NEXT DO NOTE .1 <- HERE(TREASURE).
	DO .2 <- #1
...
(91)	DO FORGET #1
	...
	DO NOT [DWARF 5.LOC] ,61002SUB#5#1
	DO NOT [DWARF 6.LOC] ,61002SUB#6#1
	DO NOT [TALLY] ,61000SUB#29
	DO NOT [TALLY2] ,61000SUB#30
	DO NOT [DTOTAL] .5
	DO NOT [ATTACK] .6
	DO NOT [STICK] .7
...
(93)	DO FORGET #1
	...
	DO (40021) NEXT DO NOTE IF DFLAG EQ #2, .1 <- #3, ELSE .1 <- DFLAG
	DO ,61000SUB#10 <- .1 DO NOTE IF DFLAG EQ #2, DFLAG <- #3
	DO .1 <- .6 DO NOTE .1 <- ATTACK
	DO .2 <- #1
...
(258)	DO (40011) NEXT DO NOTE .1=.2 DARK HINT
	...
	DO .1 <- ,61003SUB#60#5 DO NOTE .1 <- PYRAMID.PROPNEG
	DO .2 <- #1
...
(308)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO .1 <- ,61000SUB#7 DO NOTE .1 <- KNFLOC
	DO .2 <- ,61000SUB#1 DO NOTE .2 <- LOC
	DO .3 <- ,61000SUB#1 DO NOTE .3 <- LOC
	DO .4 <- #0
	DO (40021) NEXT DO NOTE IF KNFLOC EQ LOC, .1 <- LOC, ELSE .1 <- #0
	DO .4 <- .1
	DO .1 <- ,61000SUB#7 DO NOTE .1 <- KNFLOC
	DO .2 <- #65535
	DO .3 <- #65535
	DO (40021) NEXT DO NOTE IF KNFLOC EQ #65535, .1 <- #65535
	DO ,61000SUB#7 <- .1 DO NOTE IF KNFLOC NE LOC AND KNFLOC NE #65535, KNFLOC <- #0
...
(314)	DO FORGET #1
	...
	DO (331) NEXT DO NOTE AUTO-REPLACE BATTERIES
	DO (336) NEXT DO NOTE GIVE UP IF LAMP IS DEAD AND OUTSIDE
	DO (341) NEXT DO NOTE USE UP LAMP AND CHECK FOR LAMP GOING DEAD
	DO (346) NEXT DO NOTE CHECK FOR OTHER CASES OF LAMP DYING
	DO (391) NEXT
	PLEASE STOP
...
(322)	DO .1 <- ,61000SUB#16 DO NOTE .1 <- CLOCK1
	...
	DO ,60007SUB#23#1 <- #115 DO NOTE MIRROR.LOC1 <- #115
...
(324)	DO (40011) NEXT DO NOTE .1=.2 END (323) LOOP
	...
	PLEASE ANOTHER WAY WE CAN FORCE AN END TO THINGS IS BY HAVING THE LAMP
	       GIVE OUT.  WHEN IT GETS CLOSE, WE COME HERE TO WARN HIM.  WE GO
	       TO 12000 IF THE LAMP AND FRESH BATTERIES ARE HERE, IN WHICH CASE
	       WE REPLACE THE BATTERIES AND CONTINUE.  12200 IS FOR OTHER CASES
	       OF LAMP DYING.  12400 IS WHEN IT GOES OUT, AND 12600 IS IF HE'S
	       WANDERED OUTSIDE AND THE LAMP IS USED UP, IN WHICH CASE WE FORCE
	       HIM TO GIVE UP.
	PLEASE REPLACE THE BATTERIES AND CONTINUE
(331)	DO .1 <- #30
	DO .2 <- ,61003SUB#2#4 DO NOTE .2 <- LAMP.PROP
	DO (1000) NEXT DO NOTE .3 <- #30 + LAMP.PROP
	DO .1 <- .3
	DO .2 <- ,61000SUB#5 DO NOTE .2 <- LIMIT
	DO (40012) NEXT DO NOTE .1>=.2 #30+LAMP.PROP GE LIMIT, I.E. LIMIT LE #30+LAMP.PROP
	DO .1 <- #39 DO (30111) NEXT DO NOTE .1 <- HERE(BATTERIES).
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 HERE(BATTERIES).
	DO .1 <- ,61003SUB#39#4 DO NOTE .1 <- BATTERIES.PROP
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 BATTERIES.PROP EQ #0
	DO .1 <- #2 DO (30111) NEXT DO NOTE .1 <- HERE(LAMP).
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 HERE(LAMP).
	DO FORGET #1
	DO .1 <- #188
	DO (55601) NEXT DO NOTE RSPEAK
	DO ,61003SUB#39#4 <- #1 DO NOTE BATTERIES.PROP <- #1
	DO (332) NEXT DO NOTE IF TOTING(BATTERIES), DROP BATTERIES
	DO .1 <- ,61000SUB#5 DO NOTE .1 <- LIMIT
	DO .2 <- #2500
	DO (1000) NEXT
	DO ,61000SUB#5 <- .3 DO NOTE LIMIT <- LIMIT + #2500
	DO ,61000SUB#24 <- #0 DO NOTE LMWARN <- #0
	DO (391) NEXT
	PLEASE STOP
(332)	DO .1 <- #39 DO (30101) NEXT DO NOTE .1 <- TOTING(BATTERIES).
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 TOTING(BATTERIES).
	DO .2 <- ,61000SUB#1 DO NOTE .2 <- LOC
	DO (30001) NEXT DO NOTE MOVE BATTERIES TO LOC
	DO RESUME #1
	PLEASE STOP

	PLEASE GIVE UP IF OUTSIDE AND LAMP IS DEAD
(336)	DO .1 <- ,61000SUB#5 DO NOTE .1 <- LIMIT
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 LIMIT EQ #0
	DO .1 <- #8
	DO .2 <- ,61000SUB#1 DO NOTE .2 <- LOC
	DO (40012) NEXT DO NOTE .1>=.2 #8 GE LOC, I.E. LOC LE #8
	DO FORGET #1
	DO .1 <- #185
	DO (55601) NEXT DO NOTE RSPEAK
	DO ,61000SUB#27 <- #1 DO NOTE GAVEUP <- #1
	...
	PLEASE USE UP LAMP AND CHECK FOR LAMP GOING DEAD
(341)	DO .1 <- ,61003SUB#2#4 DO NOTE .1 <- LAMP.PROP
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 LAMP.PROP EQ #1
	DO .1 <- ,61000SUB#5 DO NOTE .1 <- LIMIT
	DO (40012) NEXT DO NOTE .1>=.2 LIMIT GE #1
	DO (1010) NEXT
	DO ,61000SUB#5 <- .3 DO NOTE LIMIT <- LIMIT - #1
	DO .1 <- .3
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 LIMIT EQ #0
	DO ,61003SUB#2#4 <- #0 DO NOTE LAMP.PROP <- #0
	...
	DO .3 <- #184
	DO .4 <- #13
	DO (40021) NEXT DO NOTE IF HERE(LAMP), .1 <- #184, ELSE .1 <- #13
	DO (55601) NEXT DO NOTE RSPEAK
	DO (391) NEXT
	PLEASE STOP

	PLEASE CHECK FOR OTHER CASES OF LAMP DYING
(346)	DO .1 <- #30
	DO .2 <- ,61000SUB#5 DO NOTE .2 <- LIMIT
	DO (40012) NEXT DO NOTE .1>=.2 #30 GE LIMIT, I.E. LIMIT LE #30
	DO FORGET #1
	DO .1 <- ,61000SUB#24 DO NOTE .1 <- LMWARN
	DO .2 <- #1
	DO (390) NEXT DO NOTE IF LMWARN
	DO .1 <- #2 DO (30111) NEXT DO NOTE .1 <- HERE(LAMP).
	DO .2 <- #0
	DO (390) NEXT DO NOTE IF NOT HERE(LAMP).
	DO ,61000SUB#24 <- #1 DO NOTE LMWARN <- #1
	DO .1 <- ,61003SUB#39#1 DO NOTE .1 <- BATTERIES.LOC
	DO .2 <- #0
	DO .3 <- #183
	DO .4 <- #187
	DO (40021) NEXT DO NOTE IF BATTERIES.LOC EQ #0, .1 <- #183, ELSE .1 <- #187
	DO .4 <- .1
	DO .3 <- #189
	DO .1 <- ,61003SUB#39#4 DO NOTE .1 <- BATTERIES.PROP
	DO .2 <- #1
	DO (40021) NEXT DO NOTE IF BATTERIES.PROP EQ #1, .1 <- #189
	DO (55601) NEXT DO NOTE RSPEAK
	DO (391) NEXT
	PLEASE STOP
...
(390)	DO (40011) NEXT DO NOTE .1=.2
	DO NOT STOP, FALLTHROUGH
(391)	DO FORGET #1
	DO (392) NEXT DO NOTE IF ENTER STREAM OR ENTER WATER AND WATER
	DO (393) NEXT DO NOTE IF OIL/WATER PLANT/D0OR
	DO (400) NEXT
	PLEASE STOP
(392)	DO .1 <- ,51001SUB#3#1 DO NOTE .1 <- WORD1 INDEX
	DO .2 <- #0
	DO (40002) NEXT DO NOTE .3 <- WORD1 INDEX EQ #0
	DO .1 <- .3
	DO (40011) NEXT DO NOTE .1=.2 WORD1 INDEX NE #0
	DO .1 <- ,51001SUB#3#2 DO NOTE .1 <- WORD2 INDEX
	DO .2 <- #0
	DO (40002) NEXT DO NOTE .3 <- WORD2 INDEX EQ #0
	DO .1 <- .3
	DO (40011) NEXT DO NOTE .1=.2 WORD2 INDEX NE #0
	DO .1 <- ,60004SUB',51001SUB#3#1'#3 DO NOTE .1 <- WORD1
	DO .2 <- #259 DO NOTE .2 <- ENTER
	DO (40011) NEXT DO NOTE .1=.2 WORD1 EQ ENTER
	DO .1 <- ,60004SUB',51001SUB#3#2'#3 DO NOTE .1 <- WORD2
	DO .2 <- #533 DO NOTE .2 <- WATER
	DO (40002) NEXT DO NOTE .3 <- WORD2 EQ WATER
	DO .4 <- .3
	DO .3 <- #1
	DO .2 <- #270 DO NOTE .2 <- STREAM
	DO (40021) NEXT DO NOTE .1 <- WORD2 EQ WATER OR WORD2 EQ STREAM
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 WORD2 EQ WATER OR WORD2 EQ STREAM
	DO FORGET #1
	DO .1 <- ",60009SUB',61000SUB#1'"~#6 DO NOTE .1 <- LIQLOC(LOC).
	DO .2 <- #2
	DO .3 <- #70
	DO (240) NEXT DO NOTE IF LIQLOC(LOC) EQ WATER
	DO .1 <- #43
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
(393)	DO .1 <- ,51001SUB#3#1 DO NOTE .1 <- WORD1 INDEX
	DO .2 <- #0
	DO (40002) NEXT DO NOTE .3 <- WORD1 INDEX EQ #0
	DO .1 <- .3
	DO (40011) NEXT DO NOTE .1=.2 WORD1 INDEX NE #0
	...
	DO .1 <- ,60004SUB',51001SUB#3#1'#3 DO NOTE .1 <- WORD1
	DO .2 <- #533 DO NOTE .2 <- WATER
	DO (40002) NEXT DO NOTE .3 <- WORD1 EQ WATER
	DO .4 <- .3
	DO .3 <- #1
	DO .2 <- #534 DO NOTE .2 <- OIL
	DO (40021) NEXT DO NOTE .1 <- WORD1 EQ WATER OR WORD1 EQ OIL
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 WORD1 EQ WATER OR WORD1 EQ OIL
	DO .1 <- ,60004SUB',51001SUB#3#2'#3 DO NOTE .1 <- WORD2
	DO .2 <- #536 DO NOTE .2 <- PLANT
	DO (40002) NEXT DO NOTE .3 <- WORD2 EQ PLANT
	DO .4 <- .3
	DO .3 <- #1
	DO .2 <- #521 DO NOTE .2 <- D0OR
	DO (40021) NEXT DO NOTE .1 <- WORD2 EQ PLANT OR WORD2 EQ D0OR
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 WORD2 EQ PLANT OR WORD2 EQ D0OR
	DO ,51001SUB#3#2 <- ,51001SUB#3#1 DO NOTE WORD2 INDEX <- WORD1 INDEX
	DO ,51001SUB#3#1 <- #237 DO NOTE WORD1 INDEX <- POUR
	DO ,51001SUB#3#9 <- ,51001SUB#3#7 DO NOTE WORD2(1..3) <- WORD1(1..3).
	DO ,51001SUB#3#10 <- ,51001SUB#3#8 DO NOTE WORD2(4..5) <- WORD1(4..5).
	DO ,51001SUB#2#1 <- ,51001SUB#1#1
	DO ,51001SUB#2#2 <- ,51001SUB#1#2
	DO ,51001SUB#2#3 <- ,51001SUB#1#3
	DO ,51001SUB#2#4 <- ,51001SUB#1#4
	DO ,51001SUB#2#5 <- ,51001SUB#1#5
	DO ,51001SUB#2#6 <- ,51001SUB#1#6
	DO ,51001SUB#2#7 <- ,51001SUB#1#7
	DO ,51001SUB#2#8 <- ,51001SUB#1#8
	DO ,51001SUB#2#9 <- ,51001SUB#1#9
	DO ,51001SUB#2#10 <- ,51001SUB#1#10
	DO ,51001SUB#2#11 <- ,51001SUB#1#11
	DO ,51001SUB#2#12 <- ,51001SUB#1#12
	DO ,51001SUB#2#13 <- ,51001SUB#1#13
	DO ,51001SUB#2#14 <- ,51001SUB#1#14
	DO ,51001SUB#2#15 <- ,51001SUB#1#15 DO NOTE WORD2 TEXT <- WORD1 TEXT
	DO RESUME #1
	PLEASE STOP
...
(404)	DO (40011) NEXT DO NOTE .1=.2
	DO NOTE GEE, I DON'T UNDERSTAND.
	DO FORGET #1
	DO .1 <- ,51001SUB#3#4 DO NOTE .1 <- CURRENT WORD INDEX INDEX
...
(501)	DO FORGET #1
	...
	DO (503) NEXT
	PLEASE STOP
(502)	DO (40011) NEXT DO NOTE .1=.2 NULL
	DO FORGET #1
	DO (5) NEXT
	PLEASE STOP
(503)	DO FORGET #1
	...
	DO (505) NEXT
	PLEASE STOP
(504)	DO (40011) NEXT DO NOTE .1=.2 BACK
	DO FORGET #1
	DO (10331) NEXT
	PLEASE STOP
(505)	DO FORGET #1
...
(620)	DO (40011) NEXT DO NOTE .1=.2 INTRANSITIVE EAT
	...
	DO .2 <- #0
	DO (612) NEXT DO NOTE HERE(FOOD).
	DO .1 <- #19
	DO .2 <- #0
	DO (30001) NEXT DO NOTE MOVE FOOD TO #0
	DO .1 <- #72
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
(621)	DO (40011) NEXT DO NOTE .1=.2 DRINK
	DO FORGET #1
	DO (10351) NEXT
	PLEASE STOP
...
(653)	DO (40011) NEXT DO NOTE .1=.2 SAY
	DO FORGET #1
	PLEASE BUG THIS SHOULD BE UNREACHABLE
	PLEASE STOP
...
(660)	DO (40011) NEXT DO NOTE .1=.2 EAT
	...
	DO .3 <- #71
	DO .1 <- #8 DO (240) NEXT DO NOTE IF OBJECT EQ BIRD
	DO .1 <- #11 DO (240) NEXT DO NOTE IF OBJECT EQ SNAKE
	DO .1 <- #14 DO (240) NEXT DO NOTE IF OBJECT EQ CLAM
	DO .1 <- #15 DO (240) NEXT DO NOTE IF OBJECT EQ OYSTER
	DO .1 <- #17 DO (240) NEXT DO NOTE IF OBJECT EQ DWARF
	DO .1 <- #31 DO (240) NEXT DO NOTE IF OBJECT EQ DRAGON
	DO .1 <- #33 DO (240) NEXT DO NOTE IF OBJECT EQ TROLL
	DO .1 <- #35 DO (240) NEXT DO NOTE IF OBJECT EQ BEAR
	DO .1 <- #19
	DO (40003) NEXT DO NOTE .3 <- OBJECT NE FOOD
	DO .1 <- .3
	DO .2 <- #1
	DO .3 <- #110
	DO (240) NEXT DO NOTE IF OBJECT NE FOOD
	DO .1 <- #19
	DO .2 <- #0
	DO (30001) NEXT DO NOTE MOVE FOOD TO #0
	DO .1 <- #72
...
(662)	DO (40011) NEXT DO NOTE .1=.2 RUB
	...
	DO .2 <- #2
	DO .3 <- #75
	DO (240) NEXT DO NOTE IF OBJECT EQ LAMP
	DO .1 <- #76
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
...
(670)	DO (40011) NEXT DO NOTE .1=.2 WAKE
	...
	DO .1 <- ,61000SUB#22 DO NOT .1 <- OBJECT
	DO .2 <- #17
	DO (40003) NEXT DO NOTE .3 <- OBJECT NE DWARF
	DO .1 <- .3
	DO .2 <- #1
	DO .3 <- #110
	DO (240) NEXT DO NOTE IF OBJECT NE DWARF
	DO .1 <- #199
	DO (55601) NEXT DO NOTE RSPEAK
	DO .1 <- #136
	DO (55601) NEXT DO NOTE RSPEAK
...
(715)	DO (40011) NEXT DO NOTE .1=.2 KNIFE
	DO .1 <- ,61000SUB#1 DO NOTE .1 <- LOC
	DO .2 <- ,61000SUB#7 DO NOTE .2 <- KNFLOC
	DO (40011) NEXT DO NOTE .1=.2 LOC EQ KNFLOC
	DO FORGET #1
	DO ,61000SUB#7 <- #65535 DO NOTE KNFLOC <- #65535
	DO .1 <- #116
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
...
(730)	DO (40011) NEXT DO NOTE .1=.2 PLANT
	DO .1 <- ,61003SUB#25#4 DO NOTE .1 <- PLANT2.PROP
	DO .2 <- #1
	DO (40012) NEXT DO NOTE .1>=.2 PLANT2.PROP GE #1
	DO .1 <- #25 DO (30121) NEXT DO NOTE .1 <- AT(PLANT2).
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 IF AT(PLANT2).
	DO ,61000SUB#22 <- #25 DO NOTE OBJECT <- PLANT2
	DO (712) NEXT
	PLEASE STOP
...
(736)	DO FORGET #1
	...
	DO (241) NEXT
	PLEASE STOP
(737)	DO (40011) NEXT DO NOTE .1=.2 VERB EQ FIND OR VERB EQ INVEN
	DO FORGET #1
	DO (10361) NEXT
	PLEASE STOP
...
(10001)	DO FORGET #1
	...
	DO (10003) NEXT
	PLEASE STOP
(10002)	DO .1 <- ,61000SUB#11 DO NOTE .1 <- NUMDIE
	DO .2 <- #3
	DO (40011) NEXT DO NOTE .1=.2 NUMDIE EQ MAXDIE
	DO FORGET #1
	DO (10051) NEXT
	PLEASE STOP
(10003)	DO FORGET #1
...
(10004)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO (1020) NEXT
	DO (55601) NEXT DO NOTE RSPEAK
	DO (10002) NEXT DO NOTE CHECK FOR MAXDIE
	DO .1 <- #21
	DO .2 <- #0
	DO (30001) NEXT DO NOTE MOVE WATER TO #0
	DO .1 <- #22
	DO .2 <- #0
	DO (30001) NEXT DO NOTE MOVE OIL TO #0
	DO .1 <- #2
	DO (30101) NEXT DO NOTE .1 <- TOTING(LAMP).
	DO .2 <- #1
	DO .3 <- #0
	DO .4 <- ,61003SUB#2#4 DO NOTE .4 <- LAMP.PROP
	DO (40021) NEXT DO NOTE IF TOTING(LAMP), .1 <- #0, ELSE .1 <- LAMP.PROP
	DO ,61003SUB#2#4 <- .1 DO NOTE IF TOTING(LAMP), LAMP.PROP <- #0
	DO .5 <- #64
	DO (10005) NEXT
	PLEASE STOP
	PLEASE FOR .5 IN #64 .. #1
(10005)	DO FORGET #1
	DO (10006) NEXT DO NOTE MOVE
	DO .1 <- .5
	DO .2 <- #1
	DO (10008) NEXT
	DO (1010) NEXT
...
(10006)	DO .1 <- .5
	...
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 TOTING(OBJ).
	DO .3 <- ,61000SUB#18 DO NOTE .3 <- OLDLC2
	DO .1 <- .5
	DO .2 <- #2
	DO (10007) NEXT DO NOTE IF OBJ EQ LAMP, .3 <- #1
	DO .2 <- .3
	DO (30001) NEXT DO NOTE MOVE OBJ TO OLDLC2 OR #1
	DO RESUME #1
	PLEASE STOP
(10007)	DO (40011) NEXT DO NOTE .1=.2 OBJ EQ LAMP
	DO .3 <- #1
	DO RESUME #1
	PLEASE STOP
(10008)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO ,61000SUB#1 <- #3 DO NOTE LOC <- #3
	DO ,61000SUB#3 <- #3 DO NOTE OLDLOC <- #3
	DO (101) NEXT
	PLEASE STOP
...
(10121)	DO FORGET #1
	...
	DO .2 <- #0
	DO (40021) NEXT DO NOTE .1 <- OBJ EQ PLANT AND PLANT.PROP EQ #0
	DO .2 <- #1
	DO .3 <- #115
	DO (240) NEXT DO NOTE IF OBJ EQ PLANT AND PLANT.PROP EQ #0
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJ
	DO .2 <- #35
...
(10129)	DO .1 <- ,61003SUB#20#4 DO NOTE .1 <- BOTTLE.PROP
	...
	DO RESUME #2
	PLEASE STOP
	PLEASE CHOOSE IMPLICIT OBJECT TO TAKE
...
(10171)	DO FORGET #1
	...
	DO (30111) NEXT DO NOTE .1 <- HERE(CHAIN).
	DO .4 <- .1
...
(10183)	DO (40011) NEXT DO NOTE .1=.2 D0OR
	DO FORGET #1
	DO .1 <- ,61003SUB#9#4 DO NOTE .1 D0OR.PROP
	DO .2 <- #1
	DO .3 <- #54
	DO (240) NEXT
	DO .1 <- #111
...
(10201)	DO FORGET #1
	...
	DO (10213) NEXT DO NOTE IF OBJECT EQ BIRD
	DO (241) NEXT
	PLEASE STOP
...
(10212)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	...
	DO RESUME #1
	PLEASE STOP
(10213)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #8
	DO (40011) NEXT DO NOTE OBJECT EQ BIRD
	DO ,61003SUB#8#4 <- #0 DO NOTE BIRD.PROP <- #0
	DO RESUME #1
	PLEASE STOP
	...
	PLEASE POUR.  IF NO OBJECT, OR OBJECT IS BOTTLE, ASSUME CONTENTS OF
	       ...
	       RUSTY DOOR.
(10221)	DO FORGET #1
	DO (10225) NEXT DO NOTE IF OBJECT EQ #0 AND BOTTLE.PROP NE #1, OBJECT <- BOTTLE
	DO .1 <- ,61000SUB#22
	DO .2 <- #0
	DO (612) NEXT DO NOTE IF OBJECT EQ #0
...
(10224)	DO .1 <- #24 DO (30121) NEXT DO NOTE .1 <- AT(PLANT).
	...
	DO (501) NEXT
	PLEASE STOP
(10225)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #0
	...
	DO (40003) NEXT DO NOTE .3 <- BOTTLE.PROP NE #1
	DO .1 <- .3
	DO (40011) NEXT DO NOTE .1=.2 BOTTLE.PROP NE #1
	DO ,61000SUB#22 <- #20 DO NOTE OBJECT <- BOTTLE
	DO RESUME #1
	PLEASE STOP
...
(10244)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	...
	DO .1 <- ,61003SUB#31#4 DO NOTE .1 <- DRAGON.PROP
	DO .2 <- #0
	DO (40021) NEXT DO NOTE .1 <- AT(DRAGON) AND DRAGON.PROP EQ #0
	DO .2 <- #1
	DO .3 <- #152
	DO (10246) NEXT DO NOTE IF AT(DRAGON) AND DRAGON.PROP EQ #0
	DO .1 <- #33 DO (30121) NEXT DO NOTE .1 <- AT(TROLL).
	DO .2 <- #1
	DO .3 <- #158
	DO (10246) NEXT DO NOTE IF AT(TROLL).
	DO (10247) NEXT DO NOTE TEST FOR BEAR
...
(10246)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO (501) NEXT
	PLEASE STOP
(10247)	DO .1 <- #35 DO (30111) NEXT DO NOTE .1 <- HERE(BEAR).
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 HERE(BEAR).
	DO .1 <- ,61003SUB#35#4 DO NOTE .1 <- BEAR.PROP
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 BEAR.PROP EQ #0
	DO FORGET #1
	DO NOTE THIS'LL TEACH HIM TO THROW THE AXE AT THE BEAR!
	DO .1 <- #28 DO .2 <- ,61000SUB#1 DO (30001) NEXT DO NOTE MOVE AXE TO LOC
	DO ,61003SUB#28#4 <- #1 DO NOTE AXE.PROP <- #1
	DO ,60007SUB#28#2 <- #65535 DO NOTE AXE.FIXD <- #65535
	DO .1 <- #35
	DO .2 <- ,61003SUB#35#1
	DO (30001) NEXT DO NOTE JUGGLE BEAR: MOVE BEAR TO BEAR.LOC
	DO .1 <- #164
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
...
(10271)	DO FORGET #1
	DO (10281) NEXT DO NOTE CHOOSE IMPLICIT OBJECT
...
(10278)	DO .1 <- ,61000SUB#22
	...
	PLEASE STOP
(10281)	DO .1 <- ,61000SUB#22
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ #0
	DO .1 <- ,61000SUB#1 DO NOTE .1 <- LOC
	DO .2 <- ,61002SUB#1#1 DO NOTE .2 <- DLOC(#1).
	DO .5 <- #17 DO NOTE DWARF
	DO (10282) NEXT DO NOTE IF DWARF(1).
	DO .2 <- ,61002SUB#2#1 DO NOTE .2 <- DLOC(#2).
	DO (10282) NEXT DO NOTE IF DWARF(2).
	DO .2 <- ,61002SUB#3#1 DO NOTE .2 <- DLOC(#3).
	DO (10282) NEXT DO NOTE IF DWARF(3).
	DO .2 <- ,61002SUB#4#1 DO NOTE .2 <- DLOC(#4).
	DO (10282) NEXT DO NOTE IF DWARF(4).
	DO .2 <- ,61002SUB#5#1 DO NOTE .2 <- DLOC(#5).
	DO (10282) NEXT DO NOTE IF DWARF(5).
	DO .1 <- #11 DO (30111) NEXT DO NOTE .1 <- HERE(SNAKE).
	DO .2 <- #1
	DO .5 <- #11
	DO (10282) NEXT DO NOTE IF SNAKE
	DO .1 <- #31 DO (30121) NEXT DO NOTE .1 <- AT(DRAGON).
	DO .3 <- .1
	DO .1 <- ,61003SUB#31#4 DO NOTE .1 <- DRAGON.PROP
	DO .2 <- #0
	...
	DO .2 <- #1
	DO .5 <- #31
	DO (10282) NEXT DO NOTE IF AT(DRAGON) AND DRAGON.PROP EQ #0
	DO .1 <- #33 DO (30121) NEXT DO NOTE .1 <- AT(TROLL).
	DO .2 <- #1
	DO .5 <- #33
	DO (10282) NEXT DO NOTE IF AT(TROLL).
	DO .1 <- #35 DO (30111) NEXT DO NOTE .1 <- HERE(BEAR).
	DO .3 <- .1
	DO .1 <- ,61003SUB#35#4 DO NOTE .1 <- BEAR.PROP
	DO .2 <- #0
	DO .4 <- #0
	DO (40021) NEXT DO NOTE .1 <- HERE(BEAR) AND BEAR.PROP EQ #0
	DO .2 <- #1
	DO .5 <- #35
	DO (10282) NEXT DO NOTE IF HERE(BEAR) AND BEAR.PROP EQ #0
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 OBJECT STILL #0
	DO NOTE CAN'T ATTACK BIRD BY THROWING AXE
	DO .1 <- #8 DO (30111) NEXT DO NOTE .1 <- HERE(BIRD).
	DO .4 <- .1
	DO .1 <- ,61000SUB#21 DO NOTE .1 <- VERB
	DO .2 <- #17 DO NOTE .2 <- THROW
	DO .3 <- #0
	DO (40021) NEXT DO NOTE .1 <- VERB NE THROW AND HERE(BIRD).
	DO .2 <- #1
	DO .5 <- #8
	DO (10282) NEXT DO NOTE IF VERB NE THROW AND HERE(BIRD).
	DO .1 <- #14 DO (30111) NEXT DO NOTE .1 <- HERE(CLAM).
	DO .2 <- #1
	DO .5 <- #14
	DO (10282) NEXT DO NOTE IF HERE(CLAM).
	DO .1 <- #15 DO (30111) NEXT DO NOTE .1 <- HERE(OYSTER).
	DO .2 <- #1
	DO .5 <- #15
	DO (10282) NEXT DO NOTE IF HERE(OYSTER).
	DO RESUME #1
	PLEASE STOP
(10282)	DO (40011) NEXT DO NOTE .1=.2
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #0
	DO (40002) NEXT DO NOTE .3 <- OBJECT EQ #0
	DO .4 <- .3
	DO .2 <- .5
	DO .3 <- #1
	DO (40021) NEXT DO NOTE .1 <- OBJECT EQ #0 OR OBJECT EQ .5
	DO .2 <- #1
	DO (10283) NEXT DO NOTE OBJECT IS AMBIGUOUS
	DO FORGET #2
	DO ,61000SUB#22 <- #0 DO NOTE OBJECT <- #0
	DO .2 <- .1
	DO (612) NEXT
	PLEASE STOP
(10283)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO ,61000SUB#22 <- .5 DO NOTE OBJECT <- .5
	DO RESUME #1
	PLEASE STOP
...
(10291)	DO FORGET #1
	...
	DO (240) NEXT
	DO .2 <- #15
	DO (40003) NEXT DO NOTE .3 <- OBJECT NE OYSTER
	DO .1 <- .3
	DO .2 <- #1
	DO .3 <- #195
	DO (240) NEXT DO NOTE IF OBJECT NE OYSTER
	DO .1 <- #15 DO (30101) NEXT DO NOTE .1 <- TOTING(OYSTER).
	DO .2 <- #0
	DO .3 <- #195
	DO (240) NEXT DO NOTE IF NOT TOTING OYSTER
	DO .1 <- ,61004SUB#2#1 DO NOTE .1 <- HINTED(#2).
	DO .2 <- #1
	DO .3 <- #194
	DO (240) NEXT DO NOTE IF HINTED(#2).
	DO .1 <- #192
	DO (55601) NEXT DO NOTE RSPEAK
	DO (57101) NEXT DO NOTE .1 <- YES().
	DO .2 <- #2
	DO .3 <- #54
	DO (240) NEXT DO NOTE IF NO
	DO ,61004SUB#2#1 <- #1 DO NOTE HINTED(#2) <- #1
	DO .1 <- #193
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
(10297)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	...
	DO .4 <- #2
	DO (10299) NEXT
	DO .1 <- #16 DO (30111) NEXT DO NOTE .1 <- HERE(MAGAZINE).
	DO .2 <- #1
	DO .3 <- #16 DO NOTE .3 <- MAGAZINE
	DO (10298) NEXT
	DO .1 <- #13 DO (30111) NEXT DO NOTE .1 <- HERE(TABLET).
	DO .2 <- #1
	DO .3 <- #13 DO NOTE .3 <- TABLET
	DO (10298) NEXT
	DO .1 <- #36 DO (30111) NEXT DO NOTE .1 <- HERE(MESSAGE).
	DO .2 <- #1
	DO .3 <- #36 DO NOTE .3 <- MESSAGE
	DO (10298) NEXT
	DO .1 <- #15 DO (30111) NEXT DO NOTE .1 <- HERE(OYSTER).
	DO .1 <- '&.1¢,61000SUB#26'~#1 DO NOTE .1 <- HERE(OYSTER) AND CLOSED
	DO .2 <- #1
	DO .3 <- #15 DO NOTE .3 <- OYSTER
	DO (10298) NEXT
	DO (30161) NEXT DO NOTE .1 <- DARK()
	DO .1 <- '#65535~,61000SUB#22'~#1 DO NOTE .1 <- OBJECT NE #0
	DO .2 <- #1
	DO .4 <- #2
	DO (10299) NEXT DO NOTE IF OBJECT EQ #0
	DO RESUME #1
	PLEASE STOP
(10298)	DO (40011) NEXT DO NOTE .1=.2
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #0
	DO ,61000SUB#22 <- .3 DO NOTE OBJECT <- .3
	DO .4 <- #3
	DO (10299) NEXT DO NOTE IF OBJECT NE #0
	DO RESUME #1
	PLEASE STOP
...
(10321)	DO FORGET #1
	...
	PLEASE HANDLE "GO BACK".  LOOK FOR VERB WHICH GOES FROM LOC TO OLDLOC,
	       OR TO OLDLC2 IF OLDLOC HAS FORCED-MOTION.  K2 SAVES
	       ENTRY -> FORCED LOC -> PREVIOUS LOC.
	       .5 IS K, .6 IS KK, .7 IS K2
(10331)	DO FORGET #1
	DO .5 <- ,61000SUB#3 DO NOTE .5 <- OLDLOC
	DO (10332) NEXT DO NOTE IF FORCED(OLDLOC), .5 <- OLDLC2
	DO ,61000SUB#18 <- ,61000SUB#3 DO NOTE OLDLC2 <- OLDLOC
	DO ,61000SUB#3 <- ,61000SUB#1 DO NOTE OLDLOC <- LOC
	DO (10333) NEXT DO NOTE IF .5 NE LOC
	DO .6 <- ,60013SUB',61000SUB#1' DO NOTE .6 <- TRAVELSTARTINDEX(LOC).
	DO .7 <- #0
	DO (10334) NEXT
	PLEASE STOP
(10332)	DO .1 <- ,61000SUB#3 DO NOTE .1 <- OLDLOC
	DO (30151) NEXT DO NOTE .1 <- FORCED(OLDLOC).
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 FORCED(OLDLOC).
	DO .5 <- ,61000SUB#18 DO NOTE .5 <- OLDLC2
	DO RESUME #1
	PLEASE STOP
(10333)	DO .1 <- .5
	DO .2 <- ,61000SUB#1 DO NOTE .2 <- LOC
	...
	PLEASE STOP
(10334)	DO FORGET #1
	DO .1 <- ,60003SUB.6#1 DO NOTE .1 <- TRAVEL.SRC
	DO .2 <- ,61000SUB#1 DO NOTE .2 <- LOC
	DO (40003) NEXT DO NOTE .3 <- TRAVEL.SRC NE LOC
	DO .1 <- .3
	DO .2 <- #1
	DO (10338) NEXT
	DO .1 <- ',60003SUB.6#2'~#65280 DO NOTE .1 <- TRAVEL.DEST.TAG
	DO .2 <- #1
	DO (40003) NEXT DO NOTE .3 <- TRAVEL.DEST.TAG NE #1
	DO .1 <- .3
	DO (10336) NEXT DO NOTE IF TRAVEL.DEST.TAG NE #1
	DO .1 <- ',60003SUB.6#2'~#255 DO NOTE .1 <- TRAVEL.DEST.VALUE
	DO .2 <- .5
	DO (10339) NEXT
	DO (10335) NEXT
	DO (10337) NEXT
	PLEASE STOP
(10335)	DO .1 <- ',60003SUB.6#2'~#255 DO NOTE .1 <- TRAVEL.DEST.VALUE
	DO (30151) NEXT DO NOTE .1 <- FORCED(TRAVEL.DEST.VALUE).
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 FORCED(TRAVEL.DEST.VALUE).
	DO .1 <- ",60003SUB',60013SUB"',60003SUB.6#2'~#255"'#2"~#255 DO NOTE .1 <- TRAVEL(KEY(TRAVEL.DEST.VALUE)).DEST.VALUE
	DO .2 <- .5 DO NOTE .2 <- K
	DO (40011) NEXT DO NOTE .1=.2 ENTRY->FORCED LOC->PREVIOUS LOC
	DO .7 <- .6 DO NOTE K2 <- KK
	DO RESUME #1
	PLEASE STOP
(10336)	DO (40011) NEXT DO NOTE .1=.2
	DO NOT STOP, FALLTHROUGH
(10337)	DO FORGET #1
	DO .1 <- .6
	DO (1020) NEXT
	...
	DO (10334) NEXT
	PLEASE STOP
(10338)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO .6 <- .7 DO NOTE KK <- K2
	DO (10339) NEXT DO NOTE IF KK NE #0
	DO .1 <- #140
	DO (55601) NEXT DO NOTE RSPEAK
	DO (5) NEXT
	PLEASE STOP
(10339)	DO (40011) NEXT DO NOTE .1=.2
	DO .1 <- .6
	DO .2 <- #0
	DO (40003) NEXT DO NOTE .3 <- KK NE #0
	DO .1 <- .3
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 KK NE #0
	DO FORGET #1
	DO .5 <- ,60003SUB.6#4 DO NOTE K <- TRAVEL.VERB
	DO .6 <- ,60013SUB',61000SUB#1' DO NOTE .6 <- TRAVELSTARTINDEX(LOC).
	DO .7 <- #4
	DO (510) NEXT
	PLEASE STOP

	PLEASE DRINK.  IF NO OBJECT, ASSUME WATER AND LOOK FOR IT HERE.  IF
	       WATER IS IN THE BOTTLE, DRINK THAT, ELSE MUST BE AT A WATER LOC,
	       SO DRINK STREAM.
(10351)	DO FORGET #1
	DO (10352) NEXT DO NOTE IF NO OBJECT AND NO WATER
	DO (10353) NEXT DO NOTE IF OBJECT IS NOT WATER
	DO .1 <- #20 DO (30111) NEXT DO NOTE .1 <- HERE(BOTTLE).
	DO .2 <- #0
	DO .3 <- #73
	DO (240) NEXT DO NOTE IF NOT HERE(BOTTLE).
	DO .1 <- ,61003SUB#20#4 DO NOTE .1 <- BOTTLE.PROP
	DO .2 <- #1
	DO (240) NEXT DO NOTE IF BOTTLE.PROP EQ #1
	DO .1 <- ,61003SUB#20#4 DO NOTE .1 <- BOTTLE.PROP
	DO .2 <- #2
	DO (240) NEXT DO NOTE IF BOTTLE.PROP EQ #2
	DO ,61003SUB#20#4 <- #1 DO NOTE BOTTLE.PROP <- #1
	DO .1 <- #21 DO .2 <- #0 DO (30001) NEXT DO NOTE MOVE WATER TO #0
	DO .1 <- #74
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
(10352)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ #0
	DO .1 <- ",60009SUB',61000SUB#1'"~#6 DO NOTE .1 <- LIQLOC(LOC).
	DO .2 <- #2
	DO (40003) NEXT DO NOTE .3 <- LIQLOC(LOC) NE WATER
	DO .1 <- .3
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 LIQLOC(LOC) NE WATER
	DO .1 <- #20 DO (30111) NEXT DO NOTE .1 <- HERE(BOTTLE).
	DO .3 <- .1
	DO .4 <- #0
	DO .1 <- ,61003SUB#20#4 DO NOTE .1 <- BOTTLE.PROP
	DO .2 <- #0
	DO (40021) NEXT DO NOTE .1 <- HERE(BOTTLE) AND BOTTLE.PROP EQ #0
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 NOT(HERE(BOTTLE)) OR BOTTLE.PROP NE #0
	DO FORGET #1
	DO (612) NEXT
	PLEASE STOP
(10353)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #0
	DO (40003) NEXT DO NOTE .3 <- OBJECT NE #0
	DO .1 <- .3
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 OBJECT NE #0
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #21
	DO (40003) NEXT DO NOTE .3 <- OBJECT NE WATER
	DO .1 <- .3
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 OBJECT NE WATER
	DO FORGET #1
	DO .1 <- #110
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	...
	PLEASE FIND.  MIGHT BE CARRYING IT, OR IT MIGHT BE HERE.  ELSE GIVE
	       CAVEAT.
(10361)	DO FORGET #1
	DO .1 <- ,61000SUB#22 DO (30101) NEXT DO NOTE .1 <- TOTING(OBJECT).
	DO .2 <- #1
	DO .3 <- #24
	DO (240) NEXT DO NOTE IF TOTING(OBJECT).
	DO .1 <- ,61000SUB#26 DO NOTE .1 <- CLOSED
	DO .2 <- #1
	DO .3 <- #138
	DO (240) NEXT DO NOTE IF CLOSED
	DO .1 <- ,61000SUB#22 DO (30121) NEXT DO NOTE .1 <- AT(OBJECT).
	DO .2 <- #1
	DO .3 <- #94
	DO (240) NEXT DO NOTE IF TOTING(OBJECT).
	DO .1 <- ,61000SUB#22
	DO .2 <- #17
	DO (10363) NEXT DO NOTE IF DWARF
	DO .1 <- ,61000SUB#22
	DO .2 <- #21
	DO .4 <- #2
	DO .5 <- #0
	DO (10362) NEXT DO NOTE IF WATER
	DO .1 <- ,61000SUB#22
	DO .2 <- #22
	DO .4 <- #3
	DO .5 <- #2
	DO (10362) NEXT DO NOTE IF OIL
	DO .1 <- #59
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
(10362)	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ WATER/OIL
	DO FORGET #1
	DO .1 <- ",60009SUB',61000SUB#1'"~#6 DO NOTE .1 <- LIQLOC(LOC).
	DO .2 <- .4
	DO .3 <- #94
	DO (240) NEXT IF LIQLOC(LOC) EQ WATER/OIL
	DO .1 <- ,61003SUB#20#4 DO NOTE .1 <- BOTTLE.PROP
	DO .2 <- .5
	DO (40002) NEXT DO NOTE .3 <- BOTTLE.PROP EQ WATER/OIL
	DO .1 <- #20 DO (30121) NEXT DO NOTE .1 <- AT(BOTTLE).
	DO .2 <- #1
	DO .4 <- #0
	DO (40021) NEXT DO NOTE .1 <- AT(BOTTLE) AND BOTTLE.PROP EQ WATER/OIL
	DO .2 <- #1
	DO .3 <- #94
	DO (240) NEXT DO NOTE IF AT(BOTTLE) AND BOTTLE.PROP EQ WATER/OIL
	DO .1 <- #59
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
(10363)	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ DWARF
	DO .1 <- ,61000SUB#10 DO NOTE .1 <- DFLAG
	DO .2 <- #2
	DO (40012) NEXT DO NOTE .1>=.2 DFLAG GE #2
	DO FORGET #1
	DO .1 <- ,61000SUB#1 DO NOTE .1 <- LOC
	DO .3 <- #94
	DO .2 <- ,61002SUB#1#1 DO NOTE .2 <- DLOC(#1).
	DO (240) NEXT IF DLOC(#1) EQ LOC
	DO .2 <- ,61002SUB#2#1 DO NOTE .2 <- DLOC(#2).
	DO (240) NEXT IF DLOC(#2) EQ LOC
	DO .2 <- ,61002SUB#3#1 DO NOTE .2 <- DLOC(#3).
	DO (240) NEXT IF DLOC(#3) EQ LOC
	DO .2 <- ,61002SUB#4#1 DO NOTE .2 <- DLOC(#4).
	DO (240) NEXT IF DLOC(#4) EQ LOC
	DO .2 <- ,61002SUB#5#1 DO NOTE .2 <- DLOC(#5).
	DO (240) NEXT IF DLOC(#5) EQ LOC
	DO .1 <- #59
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP

	PLEASE BREAK.  ONLY WORKS FOR MIRROR IN REPOSITORY AND, OF COURSE, THE
	       VASE.
(10371)	DO FORGET #1
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #58
	DO (10372) NEXT DO NOTE IF OBJECT EQ VASE
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #23
	DO (10374) NEXT DO NOTE IF OBJECT EQ MIRROR
	DO .1 <- #146
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
(10372)	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ VASE
	DO .1 <- ,61003SUB#58#4 DO NOTE .1 <- VASE.PROP
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 VASE.PROP EQ #0
	DO FORGET #1
	DO .1 <- #58 DO (30101) NEXT DO NOTE .1 <- TOTING(VASE).
	DO .2 <- #1
	DO (10373) NEXT DO NOTE IF TOTING(VASE), DROP VASE
	DO ,61003SUB#58#4 <- #2 DO NOTE VASE.PROP <- #2
	DO ,60007SUB#58#2 <- #1 DO NOTE VASE.FIXD <- #65535
	DO .1 <- #198	
	DO (55601) NEXT DO NOTE RSPEAK
	DO (241) NEXT
	PLEASE STOP
(10373)	DO (40011) NEXT DO NOTE .1=.2 TOTING(VASE).
	DO .1 <- #58
	DO .2 <- ,61000SUB#1 DO NOTE .2 <- LOC
	DO (30001) NEXT DO NOTE MOVE VASE TO LOC
	DO RESUME #1
	PLEASE STOP
(10374)	DO (40011) NEXT DO NOTE .1=.2 OJECT EQ MIRROR
	DO FORGET #1
	DO .1 <- ,61000SUB#26 DO NOTE .1 <- CLOSED
	DO .2 <- #0
	DO .3 <- #148
...
(51501)	DO,60006SUB#13#2<-,51001SUB.1#1   DO,60006SUB#13#3<-,51001SUB.1#2
	...
	DO STASH .2 + .3
	DO .3 <- #2 DO (51502) NEXT
	DO .3 <- #3 DO (51502) NEXT
	DO .3 <- #4 DO (51502) NEXT
	DO .3 <- #5 DO (51502) NEXT
	DO .3 <- #6 DO (51502) NEXT
	DO .3 <- #7 DO (51502) NEXT
	DO .3 <- #8 DO (51502) NEXT
	DO .3 <- #9 DO (51502) NEXT
	DO .3 <- #10 DO (51502) NEXT
	DO .3 <- #11 DO (51502) NEXT
	DO .3 <- #12 DO (51502) NEXT
	DO .3 <- #13 DO (51502) NEXT
	DO .3 <- #14 DO (51502) NEXT
	DO .3 <- #15 DO (51502) NEXT
	DO .3 <- #16 DO (51502) NEXT
	DO (57001) NEXT DO NOTE CUSTOM MESSAGE
	DO RETRIEVE .2 + .3
	DO RESUME #1
	PLEASE STOP
(51502)	DO .1 <- ,60006SUB#13.3
	DO .2 <- #97
	DO (40012) NEXT
	DO .1 <- #123
	DO .2 <- ,60006SUB#13.3
	DO (40012) NEXT
	DO ,60006SUB#13.3 <- !2¢#0'~'#95¢#32'
	DO RESUME #1
	PLEASE STOP
...
(57306)	DO (40011) NEXT DO NOTE .1=.2
	...
	PLEASE NOTE   FIRST SUBSCRIPT IS TRAVEL INDEX
	PLEASE NOTE   SECOND SUBSCRIPT
	PLEASE NOTE     #1 IS LOCATION INDEX
	PLEASE NOTE     #2 IS TRAVEL DESTINATION
	...
	PLEASE NOTE     #3 IS IS TRAVEL CONDITION
	PLEASE NOTE       UPPER 8 BITS IS TAG
	PLEASE NOTE       LOWER 8 BITS IS VALUE
	...
	PLEASE NOTE       WHEN TAG IS #6 VALUE IS INDEX OF OBJECT WHOSE
	PLEASE NOTE         PROPERTY THAT MUST *NOT* BE #0 FOR MOTION
	PLEASE NOTE       WHEN TAG IS #7 VALUE IS INDEX OF OBJECT WHOSE
	PLEASE NOTE         PROPERTY THAT MUST *NOT* BE #1 FOR MOTION
	PLEASE NOTE       WHEN TAG IS #8 VALUE IS INDEX OF OBJECT WHOSE
	PLEASE NOTE         PROPERTY THAT MUST *NOT* BE #2 FOR MOTION
	PLEASE NOTE       WHEN TAG IS #9 VALUE IS INDEX OF OBJECT WHOSE
	PLEASE NOTE         PROPERTY THAT MUST *NOT* BE #3 FOR MOTION
	PLEASE NOTE       WHEN TAG IS #10 VALUE IS INDEX OF OBJECT WHOSE
	PLEASE NOTE         PROPERTY THAT MUST *NOT* BE #4 FOR MOTION
	PLEASE NOTE     #4 OR MORE IS LIST OF MOTION VERBS
