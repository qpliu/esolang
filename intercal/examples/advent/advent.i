...
(10282)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO .2 <- #1
	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ #0 OR OBJECT EQ .5
...
(10335)	DO .1 <- ',60003SUB.6#2'~#255 DO NOTE .1 <- TRAVEL.DEST.VALUE
	...
	DO ",60003SUB',60013SUB"',60003SUB.6#2'~#255"'#2"~#255 DO NOTE TRAVEL(KEY(TRAVEL.DEST.VALUE)).DEST.VALUE
	DO .2 <- .5 DO NOTE .2 <- K
	DO (40011) NEXT .1=.2 ENTRY->FORCED LOC->PREVIOUS LOC
