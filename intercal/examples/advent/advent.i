...
(331)	DO .1 <- ,61000SUB#5 DO NOTE .1 <- LIMIT
	DO .2 <- ,61003SUB#2#4 DO NOTE .2 <- LAMP.PROP
	DO (1000) NEXT DO NOTE .3 <- LIMIT + LAMP.PROP
	DO .1 <- #31
	DO .2 <- .3
	DO (40012) NEXT DO NOTE .1>=.2 #31 GE LIMIT+LAMP.PROP, I.E. LIMIT+LAMP.PROP LE #30
...
(336)	DO .1 <- ,61000SUB#5 DO NOTE .1 <- LIMIT
	...
	DO .1 <- #9
	DO .2 <- ,61000SUB#1 DO NOTE .2 <- LOC
	DO (40012) NEXT DO NOTE .1>=.2 #9 GE LOC, I.E. LOC LE #8
	DO FORGET #1
	DO .1 <- #185
	DO (55601) NEXT DO NOTE RSPEAK
	DO ,61000SUB#27 <- #1 DO NOTE GAVEUP <- #1
...
(341)	DO .1 <- ,61003SUB#2#4 DO NOTE .1 <- LAMP.PROP
	...
	DO (1010) NEXT
	DO ,61000SUB#5 <- .1 DO NOTE LIMIT <- LIMIT - #1
	DO .2 <- #0
	DO (40011) NEXT DO NOTE .1=.2 LIMIT EQ #0
	DO ,61003SUB#2#4 <- #0 DO NOTE LAMP.PROP <- #0
	DO .1 <- #2 DO (30111) NEXT DO NOTE .1 <- HERE(LAMP).
...
(346)	DO .1 <- #31
	DO .2 <- ,61000SUB#5 DO NOTE .2 <- LIMIT
	DO (40012) NEXT DO NOTE .1>=.2 #31 GE LIMIT, I.E. LIMIT LE #30
	DO FORGET #1
...
(392)	DO .1 <- ,51001SUB#3#1 DO NOTE .1 <- WORD1 INDEX
	...
	DO FORGET #1
	DO .1 <- ",60009SUB',61000SUB#1'"~#4 DO NOTE .1 <- LIQLOC(LOC).
	DO .2 <- #2
	DO .3 <- #70
