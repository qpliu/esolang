...
(201)	DO FORGET #1
	...
	DO .3 <- ,61004SUB',61000SUB#1'#1 DO NOTE .3 <- LOC.FIRSTOBJ
	DO (202) NEXT
	PLEASE STOP
(202)	DO FORGET #1
	DO NOT [IOBJ] .3
...
C  DEDUCT POINTS FOR HINTS.  HINTS < 4 ARE SPECIAL; SEE DATABASE DESCRIPTION.
	...
	DO GIVE UP
	PLEASE STOP
(10061) DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO,60006SUB#13#2<-#46  DO,60006SUB#13#3<-#10  DO,60006SUB#13#4<-#0
	DO (57001) NEXT DO NOTE CUSTOM MESSAGE
	DO GIVE UP
	PLEASE STOP
(10062)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
...
(30003)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO ,61004SUB.5#1 <- .6 DO NOTE OLDLOC.FIRSTOBJ <- NEXTOBJ
	DO (30004) NEXT
	PLEASE STOP
(30004)	DO FORGET #1
...
(30006)	DO FORGET #1
	...
	DO .1 <- .4
	DO (30007) NEXT
	DO .1 <- ,61004SUB.4#1 DO NOTE .1 <- NEWLOC.FIRSTOBJ
	DO ,61004SUB.4#1 <- .3 DO NOTE NEWLOC.FIRSTOBJ <- OBJ
...
(60000)	DO ,60001 <- #140 BY #1294
	...
	PLEASE NOTE
	PLEASE NOTE ,61004 IS LOCATION DATA
	PLEASE NOTE   FIRST SUBSCRIPT IS LOCATION INDEX
	PLEASE NOTE   SECOND SUBSCRIPT
	PLEASE NOTE     #1 IS FIRST OBJECT AT LOCATION (#0 FOR NONE).
	PLEASE NOTE
(61000)	DO ,61000 <- #23
	DO ,61000SUB#1 <- #1
	DO ,61000SUB#2 <- #1
