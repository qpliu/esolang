...
(11)	DO (12) NEXT
	...
	DO (2) NEXT
	PLEASE STOP
(12)	DO RESUME '∀"'#511~"'∀#201¢.1'~'#0¢#511'"'~#1"¢#1'~#3
	PLEASE STOP
(13)	DO .3 <- .1
	DO (14) NEXT
	DO NOTE IN VOCABULARY TABLE
	DO [VERB INDEX] ',60004SUB.1#3'~#255
	DO [VERB TAG] ',60004SUB.1#3'~#65280
	DO .3 <- ",60004SUB.1#3"~#65280
	DO (16) NEXT
	DO NOTE NOT ACTION VERB
	DO RESUME #1
	PLEASE STOP
(14)	DO (15) NEXT
	DO RESUME #2
	PLEASE STOP
(15)	DO RESUME '∀"#65535~.3"¢#1'~#3
(16)	DO (17) NEXT
	DO FORGET #1
	DO NOTE GOT ACTION VERB
	DO .3 <- ,60008SUB"',60004SUB.1#3'~#255"
	DO [ACTION VERB] ',60004SUB.1#3'~#255
	DO [ACTION VERB DEFAULT] .3
	DO (14) NEXT
	DO NOTE ACTION VERB HAS DEFAULT
	DO .1 <- .3
	DO (55601) NEXT
	DO (2) NEXT
	PLEASE STOP
(17)	DO RESUME '∀"'#255~"'∀#3¢.3'~'#0¢#255'"'~#1"¢#1'~#3
	PLEASE STOP
(18)	DO (19) NEXT
	DO NOTE SCORE
	DO FORGET #1
	...
	DO (2) NEXT
	PLEASE STOP
(19)	DO RESUME '∀"'#511~"'∀#254¢.1'~'#0¢#511'"'~#1"¢#1'~#3
	PLEASE STOP
(20)	DO (21) NEXT
	DO NOTE HOCUS
	DO FORGET #1
	...
	DO (2) NEXT
	PLEASE STOP
(21)	DO RESUME '∀"'#511~"'∀#282¢.1'~'#0¢#511'"'~#1"¢#1'~#3
...
(57102)	DO FORGET #1
	DO (51001) NEXT
	... if ,51001SUB#3#8 is nonzero, "PLEASE ANSWER THE QUESTION."
	... if ,51001SUB#3#7 is Y or YES, return #1
	... if ,51001SUB#3#7 is N or NO, return #2
