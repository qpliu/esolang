...
(71)	DO (40011) NEXT DO NOTE .1=.2 PIRATE
	...
	DO (91) NEXT DO NOTE IF LOC EQ CHLOC
...
(72)	DO FORGET #1
	...
	PLEASE STOP
(73)	DO [...IF TOTING(.8)]
	DO [... .8 NE PYRAMID(#60) OR LOC NE PLOVER(#100)]
	DO [... .8 NE EMERALD(#59) OR LOC NE DARK ROOM(#101)]
	DO .1 <- #128
	DO (55601) NEXT DO NOTE RSPEAK
	...
	DO [... ITERATE OVER TREASURES]
	DO [...   IF PYRAMID AND LOC EQ PLOVER, SKIP]
	DO [...   IF EMERALD AND LOC EQ DARK ROOM, SKIP]
	DO [...   IF TREASURE.FIXD NE #0, SKIP (E.G. BROKEN VASE)]
	DO [...   IF HERE(TREASURE), MOVE TREASURE TO CHLOC]
...
(75)	DO (40011) NEXT DO NOTE .1=.2 END ITERATION FROM (72) OVER TREASURES
	DO FORGET #1
	DO [... IF TALLY EQ TALLY2+#1 AND .9 EQ #0 AND MESSAG.LOC EQ #0 AND HERE(LAMP) AND LAMP.PROP EQ #1, THEN RSPEAK(#186), MOVE(CHEST,CHLOC) MOVE(MESSAGE,CHLOC2), DLOC(#6) <- CHLOC, ODLOC(#6) <- CHLOC, DSEEN(#6) <- #0, GOTO (91)]
	DO [... IF ODLOC(#6) NE DLOC(#6), THEN %20 RSPEAK(#127)]
	DO .2 <- .1
	DO (91) NEXT
	PLEASE STOP
...
(206)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO ,61000SUB#29 <- .3 DO NOTE TALLAY <- TALLY-#1
