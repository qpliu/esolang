...
(641)	DO FORGET #1
	...
	DO .2 <- #7 DO (655) NEXT DO NOTE ON
	DO .2 <- #8 DO (656) NEXT DO NOTE OFF
...
(654)	DO (40011) NEXT DO NOTE .1=.2 OPEN/LOCK
	...
	DO (241) NEXT
	PLEASE STOP
(655)	DO (40011) NEXT DO NOTE .1=.2 ON
	DO FORGET #1
	DO [...ON] ,61000SUB#22
	DO (241) NEXT
	PLEASE STOP
(656)	DO (40011) NEXT DO NOTE .1=.2 OFF
	DO FORGET #1
	DO [...OFF] ,61000SUB#22
	DO (241) NEXT
	PLEASE STOP
...
(10121)	DO FORGET #1
	...
	DO [... IF OBJ EQ BOTTLE AND BOTTLE.PROP EQ #0, WATER.LOC <- #65535]
	DO [... IF OBJ EQ BOTTLE AND BOTTLE.PROP EQ #2, OIL.LOC <- #65535]
	DO (241) NEXT
	PLEASE STOP
