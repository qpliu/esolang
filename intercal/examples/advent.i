...
(51)	DO FORGET #1
	...
	DO (30101) NEXT DO NOTE LOCATIONS OF OBJECTS IN MULTIPLE LOCATIONS
	DO NOTE ... NOT IMPLEMENTED YET
	DO (101) NEXT
...
(201)	DO FORGET #1
	...
	DO .3 <- ,61004SUB',61000SUB#1' DO NOTE .3 <- LOC.FIRSTOBJ
	DO (202) NEXT
(202)	DO FORGET #1
	DO NOT [IOBJ] .3
	DO .1 <- .3
...
(302)	DO (57108) NEXT
	DO NOTE AT EOF
	   ... NOT IMPLEMENTED YET ... GO TO QUIT AND SCORING REPORT
	DO .1 <- #1
...
(405)	DO FORGET #1
	DO [VERB VOCAB INDEX] .1
	DO [VERB TAG] ',60004SUB.1#3'~#65280
	DO [VERB VALUE] ',60004SUB.1#3'~#255
	DO [OBJ INDEX] .2
	DO .3 <- .1
	DO .4 <- .2
...
(30003)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO ,61004SUB.5 <- .6 DO NOTE OLDLOC.FIRSTOBJ <- NEXTOBJ
	DO (30004) NEXT
	PLEASE STOP
(30004)	DO FORGET #1
...
(30006)	DO FORGET #1
	...
	DO .1 <- .4
	DO (30007) NEXT
	DO .1 <- ,61004SUB.4 DO NOTE .1 <- NEWLOC.FIRSTOBJ
	DO ,61004SUB.4 <- .3 DO NOTE NEWLOC.FIRSTOBJ <- OBJ
...
(30103)	DO FORGET #1
	...
	DO (30102) NEXT
	PLEASE STOP
(30104)	DO (40011) NEXT DO NOTE .1=.2
	DO RESUME #2
	PLEASE STOP
(30105)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO (30103) NEXT
	PLEASE STOP
(30106)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO .1 <- .4
	DO (30001) NEXT DO NOTE MOVEOBJ(.1 TO .4). ... MOVE TO LAST OBJ AT LOCATION INSTEAD OF FIRST ...
	DO (30103) NEXT
	PLEASE STOP
...
(60000)	DO ,60001 <- #140 BY #1294
	...
	PLEASE NOTE
	PLEASE NOTE ,61004 IS FIRST OBJECT AT LOCATION (#0 FOR NONE).
	PLEASE NOTE   SUBSCRIPT IS LOCATION INDEX
