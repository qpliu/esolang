...
(311)	DO FORGET #1
	...
	DO NOT [TURNS] .1
	DO NOTE ... IF VERB = 'SAY' AND WD2 != '' VERB = #0
	DO NOTE ... IF VERB = 'SAY', CURRENT WORD INDEX INDEX <- #1, GOTO SAY
...
C  DEDUCT POINTS FOR HINTS.  HINTS < 4 ARE SPECIAL; SEE DATABASE DESCRIPTION.
	...
	PLEASE DO SAY
(10101)	DO .1 <- ,51001SUB#3#4 DO NOTE .1 <- CURRENT WORD INDEX INDEX
	DO .1 <- ,51001SUB#3.1 DO NOTE .1 <- CURRENT WORD INDEX
	DO .2 <- #0
	DO (10102) NEXT
...
(10104)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO [...SAY FEE/FIE/FOE/FOO/FUM] DO RESUME #1
	PLEASE STOP
(10105)	DO FORGET #1
	DO .1 <- ,51001SUB#3#4 DO NOTE .1 <- CURRENT WORD INDEX INDEX
