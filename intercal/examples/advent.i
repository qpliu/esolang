...
(405)	DO FORGET #1
	...
	DO NOT [VERB TAG] ',60004SUB.3#3'~#65280
	DO NOT [VERB VALUE] ',60004SUB.3#3'~#255
	DO .3 <- .1
	DO .4 <- .2
...
(511)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO ... NON-APPLICABLE MOTION.  VARIOUS MESSAGES DEPENDING ON WORD GIVEN.
	DO .1 <- #12
	DO (55601) NEXT DO NOTE RSPEAK
	DO (5) NEXT
	PLEASE STOP
...
(30001)	DO NOTE ... NOT IMPLEMENTED YET ...
	DO NOT [MOVE OBJ] .1
...
(30102)	DO FORGET #1
	...
	DO (30106) NEXT
	DO .1 <- ,60007SUB.4#2 DO NOTE .1 <- INITIAL LOCATION
	DO (30106) NEXT
	DO (30103) NEXT
	PLEASE STOP
(30103)	DO FORGET #1
...
(30106)	DO (40011) NEXT DO NOTE .1=.2
	DO FORGET #1
	DO .1 <- .4
	DO (30001) NEXT DO NOTE MOVEOBJ(.1 TO .4).
	DO (30103) NEXT
...
(60000)	DO ,60001 <- #140 BY #1294
	...
	PLEASE NOTE
	PLEASE NOTE ,61003 IS OBJECT LOCATION LINKED LISTS
	PLEASE NOTE   FIRST SUBSCRIPT IS OBJECT INDEX
