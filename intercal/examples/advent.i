...
(206)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO .1 <- .3 DO .2 <- #62 DO (207) NEXT DO NOTE IF OBJ EQ RUG, OBJ.PROP <- #1
	DO .1 <- .3 DO .2 <- #64 DO (207) NEXT DO NOTE IF OBJ EQ CHAIN, OBJ.PROP <- #1
...
(531)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO [...PLOVER-ALCOVE...IF HOLDING ANYTHING OTHER THAN EMERALD NEWLOC <- LOC]
	DO (5) NEXT
	PLEASE STOP
...
(10184)	DO (40011) NEXT DO NOTE .1=.2 GRATE
	...
	DO .1 <- ,61000SUB#19 DO NOTE .1 <- CLOSNG
	DO .2 <- #1
	DO (10186) NEXT DO IF NOTE CLOSNG
	DO .1 <- ,61000SUB#21 DO NOTE .1 <- VERB
	DO .2 <- #4
	DO (10185) NEXT DO IF NOTE UNLOCK
	DO .1 <- #34
...
(10241)	DO FORGET #1
	...
	DO .3 <- #29
	DO (240) NEXT DO NOTE IF NOT TOTING(OBJECT).
	DO (10242) NEXT DO NOTE IF OBJECT GE #50 AND #65 GE OBJECT LT #65 AND AT(TROLL)
	DO [...OBJECT EQ FOOD AND HERE(BEAR): OBJECT <- BEAR, GOTO FEED (10251)]
	DO [...OBJECT NE AXE, GOTO DISCARD IF OBJECT NE AXE (652)]
	DO [...THROW AXE, OBJECT <- #0, GOTO ATTACK (10271)]
	DO (241) NEXT
	PLEASE STOP
...
(10242)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	...
	DO ,60007SUB#34#1 <- #117 DO NOTE TROLL.PLAC <- #117
	DO ,60007SUB#34#2 <- #122 DO NOTE TROLL2.FIXD <- #122
	DO .1 <- #32
	DO .2 <- ,61003SUB#32#1
...
(10264)	DO (40011) NEXT DO NOTE .1=.2 FOO
	...
	DO (241) NEXT
	PLEASE STOP
(10265)	DO [...BRING BACK TROLL IF STEAL EGGS BACK BEFORE CROSSING...]
	DO RESUME #1
	PLEASE STOP
...
(10271)	DO FORGET #1
	DO .1 <- ,61000SUB#22
	DO .2 <- #0
	DO (10278) NEXT DO NOTE CHOOSE IMPLICIT OBJECT
	DO [...KILL OBJ] ,61000SUB#22
	DO [...IF OBJ EQ BIRD GOTO ...]
	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #0
	...
	DO [...IF OBJ=DWARF AND CLOSED, RSPEAK(136), GOTO EXIT (10051)]
	DO [...IF OBJ=DWARF SPK=49]
	DO [...IF OBJ=TROLL SPK=157]
	DO [...IF OBJ=BEAR, SPK=165(IF BEAR.PROP IS 0) OR 166(IF BEAR.PROP IS 1 OR 2) OR 167(IF BEAR.PROP IS 3)]
	DO [...IF OBJ NE DRAGON, SPK=110]
	DO [...IF DRAGON.PROP NE #0, SPK=167]
	DO .1 <- #49
	DO (55601) NEXT DO NOTE RSPEAK
	DO ,61000SUB#21 <- #0 DO NOTE VERB <- #0
	DO ,61000SUB#22 <- #0 DO NOTE OBJ <- #0
	...
	DO (57001) NEXT DO NOTE CUSTOM MESSAGE
	DO (51001) NEXT DO NOTE CALL GETIN
	DO [WD1(1..3)] ,51001SUB#3#7
	DO [WD1(4..5)] ,51001SUB#3#8
...
(10273)	DO (40011) NEXT DO NOTE .1=.2
	...
	DO [... MOVE ALL OBJECTS IN #119 OR #121 TO #120]
	DO ,61000SUB#1 <- #120 DO NOTE LOC <- #120
	DO .1 <- #21 DO NOTE .1 <- NULL
	DO (501) NEXT
	PLEASE STOP
(10278)	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ #0
	DO [...CHOOSE IMPLICIT KILL OBJ] DO FORGET #1 DO (241) NEXT
	PLEASE STOP

	PLEASE WAVE.  NO EFFECT UNLESS WAVING ROD AT FISSURE.
(10281)	DO FORGET #1
	DO (10283) NEXT DO NOTE IF WAVING ROD AT FISSURE
	DO (10282) NEXT DO NOTE IF OBJECT EQ ROD AND TOTING(ROD2), OBJECT <- ROD2
	...
	DO (241) NEXT
	PLEASE STOP
(10282)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #5
	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ ROD
	...
	DO RESUME #1
	PLEASE STOP
(10283)	DO .1 <- ,61000SUB#22 DO NOTE .1 <- OBJECT
	DO .2 <- #5
	DO (40011) NEXT DO NOTE .1=.2 OBJECT EQ ROD
	DO .1 <- #5 DO (30101) NEXT DO NOTE .1 <- TOTING(ROD).
	DO .2 <- #1
