...
testBag = testResolve "testBag" "f=[]." checkResult
  where
    checkResult [Def (Identifier _ "f") 0 (ExprBag _ [])] = True
    checkResult _ = False

testBag2 :: Assertion
testBag2 = testResolve "testBag2" "f=[[]]." checkResult
  where
    checkResult [Def (Identifier _ "f") 0
...
testBag4 = testResolve "testBag4" "f=[2×[][]]." checkResult
  where
    checkResult [Def (Identifier _ "f") 0
                     (ExprBag _ [(2,ExprBag _ []),(1,ExprBag _ [])])] = True
    checkResult _ = False

testBag5 :: Assertion
testBag5 = testResolve "testBag5" "f a=[a]." checkResult
  where
    checkResult [Def (Identifier _ "f") 1
...
testBinop = testResolve "testBinop" "f a b=a|b." checkResult
  where
    checkResult [Def (Identifier _ "f") 2
...
testParens = testResolve "testParens" "f a b=([])." checkResult
  where
    checkResult [Def (Identifier _ "f") 2 (ExprBag _ [])] = True
    checkResult _ = False
...
testFuncall = testResolve "testFuncall" "f a=g*a.g a=[]." checkResult
  where
    checkResult [Def (Identifier _ "f") 1
                 ...
                 Def (Identifier _ "g") 1 (ExprBag _ [])] = True
    checkResult _ = False
