...
testGenMain0 = testGenMain "testGenMain0" "f=."
    ("define void @main(i32 %argc,i8** %argv) {" ++
     ...
     " br label %l2" ++
     " l2:" ++
     " %2 = phi {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* [%0,%l1],[%13,%l7],[%13,%l6]" ++
     " %3 = phi i8 [0,%l1],[%19,%l6],[0,%l7]" ++
     " %4 = phi i8 [0,%l1],[%18,%l6],[0,%l7]" ++
     " %5 = getelementptr {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*},{i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* %2,i32 0,i32 2" ++
     " %6 = load i8*,i8** %5" ++
     " %7 = getelementptr {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*},{i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* %2,i32 0,i32 3" ++
     " %8 = bitcast {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* %2 to i8*" ++
     " %9 = load {i2,i8*}(i8*,i8*)*,{i2,i8*}(i8*,i8*)** %7" ++
     " %10 = call fastcc {i2,i8*} %9(i8* %6,i8* %8)" ++
     " %11 = extractvalue {i2,i8*} %10,0" ++
     " %12 = extractvalue {i2,i8*} %10,1" ++
     " %13 = bitcast i8* %12 to {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}*" ++
     " %14 = icmp eq i2 3,%11" ++
     " br i1 %14,label %l3,label %l4" ++
     " l3:" ++
     " call void @abort() noreturn" ++
     " ret void" ++
     " l4:" ++
     " %15 = icmp eq i2 2,%11" ++
     " br i1 %15,label %l5,label %l6" ++
     " l5:" ++
     ...
     " %19 = add i8 1,%3" ++
     " %20 = icmp ult i8 %19,8" ++
     " br i1 %20,label %l2,label %l7" ++
     " l7:" ++
     " store i8 %18,i8* %1" ++
     " %21 = call i32 @write(i32 1,i8* %1,i32 1)" ++
     " br label %l2" ++
     " }")
...
testGenMain1 = testGenMain "testGenMain1" "f a=."
    ("define void @main(i32 %argc,i8** %argv) {" ++
     ...
     " br label %l9" ++
     " l9:" ++
     " %51 = phi {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* [%49,%l8],[%62,%l14],[%62,%l13]" ++
     " %52 = phi i8 [0,%l8],[%68,%l13],[0,%l14]" ++
     " %53 = phi i8 [0,%l8],[%67,%l13],[0,%l14]" ++
     " %54 = getelementptr {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*},{i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* %51,i32 0,i32 2" ++
     " %55 = load i8*,i8** %54" ++
     " %56 = getelementptr {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*},{i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* %51,i32 0,i32 3" ++
     " %57 = bitcast {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}* %51 to i8*" ++
     " %58 = load {i2,i8*}(i8*,i8*)*,{i2,i8*}(i8*,i8*)** %56" ++
     " %59 = call fastcc {i2,i8*} %58(i8* %55,i8* %57)" ++
     " %60 = extractvalue {i2,i8*} %59,0" ++
     " %61 = extractvalue {i2,i8*} %59,1" ++
     " %62 = bitcast i8* %61 to {i32,i2,i8*,{i2,i8*}(i8*,i8*)*,void(i8*)*}*" ++
     " %63 = icmp eq i2 3,%60" ++
     " br i1 %63,label %l10,label %l11" ++
     " l10:" ++
     " call void @abort() noreturn" ++
     " ret void" ++
     " l11:" ++
     " %64 = icmp eq i2 2,%60" ++
     " br i1 %64,label %l12,label %l13" ++
     " l12:" ++
     " call void @exit(i32 0) noreturn" ++
     " ret void" ++
     " l13:" ++
